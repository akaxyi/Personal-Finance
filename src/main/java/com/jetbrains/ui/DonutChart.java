 ...
 * Pastel, rounded aesthetic to match the new UI.
 */
public class DonutChart extends JComponent {
    ...
    private final Color incomeColor = new Color(120, 210, 180);   // mint
    private final Color expenseColor = new Color(250, 200, 170);  // peach
    private final Color ringBg = new Color(235, 240, 245);        // soft bg
    ...
    @Override protected void paintComponent(Graphics g) {
        ...
        int w = getWidth();
        int h = getHeight();
        // Reserve space for legend (lh) under the donut
        ...
        // Legend (income/expense small swatches) within reserved area
        g2.setFont(base);
        ...
        g2.setColor(new Color(50,50,50)); g2.drawString("Income", lx + sw + 8, legendY);
        lx += 120;
        g2.setColor(expenseColor); g2.fillRoundRect(lx, legendY - sh, sw, sh, 6, 6);
        g2.setColor(new Color(50,50,50)); g2.drawString("Expenses", lx + sw + 8, legendY);
